defmodule Swapi.Interactors.Film.ListTest do
  use Swapi.DataCase
  import Swapi.Support.QueryPagination

  alias Swapi.Interactors.Film.List
  ...
  describe "call/1" do
    ...
    test "paginates results" do
      records = Factory.insert_list(3, :film)
    ...
    test "excludes deleted films from result entries" do
      one = fixture()
      two = fixture()
